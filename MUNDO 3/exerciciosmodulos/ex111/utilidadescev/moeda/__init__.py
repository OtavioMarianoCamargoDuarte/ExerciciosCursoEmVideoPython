...
def resumo(preco=0, taxaaumento=0, taxadesconto=0):
    """
    Exibe um resumo formatado com diversas operações financeiras realizadas sobre um valor.

        :param preco: (float, optional): O valor base a ser analisado. Padrão é 0.
        :param taxaaumento: (float, optional): A porcentagem de aumento a ser aplicada ao valor. Padrão é 0.
        :param taxadesconto: (float, optional): A porcentagem de desconto a ser aplicada ao valor. Padrão é 0.
        :return None: A função apenas imprime o resumo formatado, sem retornar um valor.
    """
    print('=' * 40)
